    ...
    <div class="room-details-slider">
        <div class="container">
            <div class="room__details__pic__slider owl-carousel">
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/room-2.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/premier2.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/premier3.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/premier-suite.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/premier.jfif"></div>
            </div>
        </div>
    </div>
