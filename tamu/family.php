    ...
    <div class="room-details-slider">
        <div class="container">
            <div class="room__details__pic__slider owl-carousel">
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/room-4.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/family2.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/family3.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/family4.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/family5.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/family.jfif"></div>
            </div>
        </div>
    </div>
