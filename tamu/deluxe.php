    ...
    <div class="room-details-slider">
        <div class="container">
            <div class="room__details__pic__slider owl-carousel">
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/room-1.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/deluxe2.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="assets/img/rooms/details/deluxe.jfif"></div>
            </div>
        </div>
    </div>
