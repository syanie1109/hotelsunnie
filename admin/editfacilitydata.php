...
<div class="bigbox">
        <table celpadding="10px">
            ...
            <thead>
                <th colspan="3">
                    <h2>This form is intented to edit facility data.</h2>
                </th>
            </thead>
            <form method="post" action="aksieditfacility.php">
            <tr>
            <?php
         include '../config.php';
         ...
         while($d = mysqli_fetch_array($data)){
           ?>
                ...
                <td width="70%">
                    <input type="text" name="id_fasilitas" value="<?php echo $d['id_fasilitas']; ?>" readonly>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="fasilitas" value="<?php echo $d['fasilitas']; ?>" />
                </td>
            </tr>
            <tr>
                <td>
