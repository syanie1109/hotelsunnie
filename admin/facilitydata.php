...
<body>
                        ...
                        <div class="header__nav">
                            <nav class="header__menu">
                                <ul class="menu__class">
                                    ...
                                    <li class="active"><a href="facilitydata.php">Facility Data</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <table celpadding="10px">
        <thead>
                <th colspan="3">
                <h5 class="card-header" style="font-size: 70px; background: transparent; margin: 10px auto 10px auto; color: darkgoldenrod;">Facility Data</h5>
                </th>
        </thead>
        <thead>
            <th colspan="3">
                <h2>This form is intented to add Facility data.</h2>
            </th>
        </thead>
        <form method="post" action="aksiaddfacility.php">
        <tr>
            <td width="25%">
                ID Facility
            </td>
            ...
            <td width="70%">
                <input type="text" name="id_fasilitas" readonly>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="file" name="photo" class="form-control" id="" style="border-radius: 30px;" />
            </td>
        </tr>
            <td>
                Describe
...
<div class="card">
                <div class="table-responsive text-nowrap">
                  <table class="table" style="height: 300px;">
                    <thead class="table-dark" style="height: 55px; background: black;">
                      <tr>
                        <th style="color: darkgoldenrod;"><center>ID Facility</th>
                        <th style="color: darkgoldenrod;"><center>Facility</th>
                        <th style="color: darkgoldenrod;"><center>Photo</th>
                        <th style="color: darkgoldenrod;"><center>Describe</th>
                        <th style="color: darkgoldenrod;"><center>Actions</th>
                      </tr>
                    </thead>
                    <?php
                  include '../config.php';
                      ...
                      <tr>
                        ...
                        <div class="dropdown"><center>
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editfacilitydata.php?id_fasilitas=<?php echo $d['id_fasilitas'];?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="deletefacilitydata.php?id_fasilitas=<?php echo $d['id_fasilitas'];?>" onclick="return confirm('Delete this data?')"
